...
## Process
- Grab YAML files from [Common Access Model](https://github.com/include-dcc/common-access-model/blob/main/src/common_access_model/schema/common_access_model.yaml)
